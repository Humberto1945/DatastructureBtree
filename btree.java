...
public class btree {
  ...
  public static void main(String[] args) {
	 ...
	 do { 
		 Scanner scanner = new Scanner(System.in);
		  System.out.println("Enter search, delete, add or q to quit");
		  String sda = scanner.nextLine();
		 // System.out.println("Enter 870 ID");
		  //int id = scanner.nextInt();
	  if (sda.contains("search")){
		  System.out.println("Enter 870 ID");
		  int id = scanner.nextInt();
		  if (b.Search(id)) {
		      System.out.println("\nID found");
	  ...
	  else if (sda.contains("delete")){ // == "delete") {
		  System.out.println("Enter 870 ID");
		  int id = scanner.nextInt();
		  if (b.Search(id)) {
			  b.Delete(id);
 ...
 /*  // Creating B-Tree
   // btree b = new btree(3);
    //inserting 870 numbers into tree
    b.Insert(870587241);
    b.Insert(870587242);
    b.Insert(870587243);
    b.Insert(870587244);
    ...
    b.Show();
    System.out.println();
    // shearch the tree for 870 number if found will say found if not will say not found
    System.out.println("look for 870587247 in B tree");
    if (b.Search(870587247)) {
      System.out.println("\nfound");
    } else {
      System.out.println("\nnot found");
    }
   // deleting 870 numbers from tree
